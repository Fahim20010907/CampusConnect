        ...
        const fetchDbUser = async () => {
            try {
                const res = await fetch(
                    `${process.env.NEXT_PUBLIC_API_URL}/api/users/by-email/${encodeURIComponent(user.email)}`
                  );
                  
                  
                  const data = await res.json();

                  console.log("data sfs",data)
                                                ...
                                                <>
                                                    <div className="border-t border-gray-100 mt-2 pt-2">
                                                        <Link
                                                            ...
                                                            className="flex items-center space-x-3 px-4 py-3 hover:bg-purple-50 text-purple-700 hover:text-purple-800 transition-colors font-medium"
                                                            onClick={() => setIsProfileDropdownOpen(false)}
                                                        >
                                                            <svg
                                                                className="w-5 h-5"
