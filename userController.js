...
import User from '../models/user.js'; // Ensure you're importing the User model

// Fetch user profile by ID
export const getUserProfile = async (req, res) => {
  try {
    const user = await User.findById(req.params.userId)
      .populate('followers', 'name profilePicture email department') // Populate followers
      .populate('following', 'name profilePicture email department') // Populate following
